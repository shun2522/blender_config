...
kmi.properties.sharpness = 3.1415927410125732
...
kmi = km.keymap_items.new_modal('CANCEL', 'LEFT_CTRL', 'PRESS', any=True)
kmi = km.keymap_items.new_modal('CANCEL', 'LEFT_CTRL', 'RELEASE', any=True)
kmi = km.keymap_items.new_modal('CANCEL', 'RIGHT_CTRL', 'PRESS', any=True)
kmi = km.keymap_items.new_modal('CANCEL', 'RIGHT_CTRL', 'RELEASE', any=True)
